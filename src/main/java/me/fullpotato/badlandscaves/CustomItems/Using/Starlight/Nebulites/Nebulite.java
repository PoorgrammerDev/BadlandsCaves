...
public enum Nebulite {
    ...
    STRONG_STANCE(CustomItem.NEBULITE_STRONG_STANCE, new CustomItem[]{CustomItem.NEBULITE_ROOTED_FEET}, CustomItem.STARLIGHT_HELMET, CustomItem.STARLIGHT_CHESTPLATE, CustomItem.STARLIGHT_LEGGINGS, CustomItem.STARLIGHT_BOOTS),
    ROOTED_FEET(CustomItem.NEBULITE_ROOTED_FEET, new CustomItem[]{CustomItem.NEBULITE_STRONG_STANCE}, CustomItem.STARLIGHT_HELMET, CustomItem.STARLIGHT_CHESTPLATE, CustomItem.STARLIGHT_LEGGINGS, CustomItem.STARLIGHT_BOOTS),
