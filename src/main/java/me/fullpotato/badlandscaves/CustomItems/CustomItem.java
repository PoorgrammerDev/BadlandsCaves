...
public enum CustomItem {
    ...
    NEBULITE_SUPERSONIC_PROPULSORS(true),
    NEBULITE_DISASSEMBLER(true),
    NEBULITE_STARLIGHT_HAMMER(true),
    NEBULITE_RICOCHET(true),
